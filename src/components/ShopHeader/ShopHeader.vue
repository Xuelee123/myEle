    ...
    <div class="shop-content" @click="isShowBulletin=!isShowBulletin">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">距离{{info.distance}}米</span>
        </div>
    ...
    <div class="shop-header-discounts" @click="isShowSupport=!isShowSupport">
      <div class="discounts-left">
        <div class="activity activity-green">
          <span class="content-tag">
            <span class="mini-tag" v-if="info.supports">{{info.supports[1].name}}</span>
          </span>
          <span class="activity-content" v-if="info.supports">{{info.supports[1].content}}</span>
        </div>
      </div>
