    ...
    <div class="shopcart">
        ...
        <div class="content-left">
          <div class="logo-wrapper" @click="showCart">
            <div class="logo" :class="{highlight:totalAmount>0}">
              <i class="iconfont icon-shopping_cart" :class="{highlight:totalAmount>0}"></i>
            </div>
      ...
      <div class="shopcart-list" v-show="listShow">
        ...
        <div class="list-content">
          <ul>
            <li class="food" v-for="(cartFood, index) in cartFood" :key="index">
              ...
              <div class="cartcontrol-wrapper">
                <div class="cartcontrol">
                  <cartControl :food="cartFood" :listShow="listShow" :isShowCart="isShowCart"/>
                </div>
              </div>
            </li>
          </ul>
...
export default {
  ...
  // 获取info对象,cartFood对象,totalAmount,totalPrice
  computed: {
    ...mapState({
      cartFood: state => state.cartFood,
    ...
    listShow() {
      ...
      if (totalAmount === 0) {
        ...
        console.log('totalAmount === 0 时的computed执行了')
        return false;
      }
      //待列表加载完毕后创建滑动对象
      //单例模式 
  ...
  methods: {
    showCart() {
      if (this.totalAmount > 0) this.isShowCart = !this.isShowCart;
